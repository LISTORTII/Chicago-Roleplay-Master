	...
	function()
		...
		if bShowConsoleText then
			...
			if age > 60*60 then
				...
				xmlSaveFile(xml)
				outputConsole( "¡Una nueva versión de MTA:SA está disponible! - Por favor descárgala de www.mtasa.com" )
			end
		end
		...
		if bShowMessageBox then
			...
			if age > 60*60*24 then
				...
				xmlSaveFile(xml)
				aMessageBox( "¡Una nueva versión de MTA:SA está disponible!",  "Por favor descárgala de www.mtasa.com" )
