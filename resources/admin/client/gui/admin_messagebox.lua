...
function aMessageBox ( type, message, action, vOne, vTwo, vThree )
	...
	if ( aMessageForm == nil ) then
		...
		aMessageYes		= guiCreateButton ( 120, 70, 55, 17, "Sí", false, aMessageForm )
	...
	if ( type == "Advertencia" ) then guiSetVisible ( aMessageWarning, true )
	elseif ( type == "Pregunta" ) then guiSetVisible ( aMessageQuestion, true )
