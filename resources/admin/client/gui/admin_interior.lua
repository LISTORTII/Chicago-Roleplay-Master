...
function aPlayerInterior ( player )
	if ( aInteriorForm == nil ) then
		...
		aInteriorForm		= guiCreateWindow ( x / 2 - 110, y / 2 - 150, 220, 300, "Administrador de interiores", false )
		aInteriorList		= guiCreateGridList ( 0.03, 0.08, 0.94, 0.73, true, aInteriorForm )
					   guiGridListAddColumn( aInteriorList, "Mundo", 0.2 )
					   guiGridListAddColumn( aInteriorList, "Descripción", 0.75 )
		aInteriorSelect		= guiCreateButton ( 0.03, 0.82, 0.94, 0.075, "Seleccionar", true, aInteriorForm )
		aInteriorCancel		= guiCreateButton ( 0.03, 0.90, 0.94, 0.075, "Cerrar", true, aInteriorForm )
