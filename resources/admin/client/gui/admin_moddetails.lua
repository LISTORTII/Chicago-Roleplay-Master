...
function aViewModdetails ( player )
	...
	if ( aModdetailsForm == nil ) then
		...
		aModdetailsForm	= guiCreateWindow ( x / 2 - 250, y / 2 - 125, 350, 350, "Ver detalles de mods", false )
		...
		aModdetailsList		= guiCreateGridList ( 0.02, 0.09, 0.72, 0.85, true, aModdetailsForm )
					   ...
					   guiGridListAddColumn( aModdetailsList, "Nombre", 0.60 )
		aModdetailsRefresh	= guiCreateButton ( 0.76, 0.78, 0.32, 0.05, "Actualizar", true, aModdetailsForm )
		aModdetailsClose	= guiCreateButton ( 0.76, 0.85, 0.32, 0.05, "Cerrar", true, aModdetailsForm )
	...
	guiSetText( aModdetailsForm, "Detalles de mods de: '" .. tostring(getPlayerName(modDetailsPlayer)) .."'" )
	aHideFloaters()
