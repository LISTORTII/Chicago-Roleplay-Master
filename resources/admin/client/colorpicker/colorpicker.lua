...
function colorPicker.create(id, start, title)
  ...
  cp.gui.edith = guiCreateLabel(338, 106, 64, 20, "H: 0Â°", false, cp.gui.window)
  ...
  cp.gui.closeb = guiCreateButton(336, 265, 64, 24, "Cancelar", false, cp.gui.window)
...
function colorPicker:updateColor()
  ...
  guiSetText(self.gui.edith, "H: "..tostring(math.round(self.color.h*360)).."Â°")
