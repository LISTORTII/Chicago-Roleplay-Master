...
addEventHandler("onResourceStart", resourceRoot, function()
	Pickup = Pickup(252.392578125, 117.3779296875, 1003.21875, 3, 1274, 0)
	Pickup:setInterior(10)
	MarcadoresMulta = Marker(252.392578125, 117.3779296875, 1003.21875-1, "cylinder", 1.3, 100, 50, 50, 0)
	MarcadoresMulta:setInterior(10)
end)
--
