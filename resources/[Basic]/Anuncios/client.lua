...
addEventHandler("onClientResourceStart", resourceRoot,
    function()
        Anunciadorawin = guiCreateWindow(0.33, 0.34, 0.31, 0.25, "Anunciadora-Chicago", true)
        guiWindowSetSizable(Anunciadorawin, false)

        Listanun = guiCreateComboBox(0.04, 0.16, 0.25, 0.48, "", true, Anunciadorawin)
        guiComboBoxAddItem(Listanun, "Anuncio-Chicago")
        guiComboBoxAddItem(Listanun, "Trabajo-Chicago")
        guiComboBoxAddItem(Listanun, "Venta-Chicago")
        guiComboBoxAddItem(Listanun, "Compra-Chicago")
