...
local pickup = createPickup( 430.22637939453, 156.48066711426, 1016.815612793, 3, 1275, 1)
...
addCommandHandler("vestuarios",
	...
	function ()
		...
		if localPlayer:getData("Roleplay:faccion") == "Medico" then
			...
			if isPedWithinRange(430.22637939453, 156.48066711426, 1016.815612793,0.1,localPlayer) then
				...
				guiGridListClear( Listaparaskins )
					...
					guiGridListSetItemData( Listaparaskins, guiGridListAddRow( Listaparaskins, 'Paramedica I' ), 1, '54' )	
					
					guiGridListSetItemData( Listaparaskins, guiGridListAddRow( Listaparaskins, 'Paramedica II' ), 1, '39' )	
