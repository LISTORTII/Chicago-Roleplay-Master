...
addEventHandler("onPlayerLogin", getRootElement(), function(p, t, a)
	if not notIsGuest(source) then
		...
		if (conducir) then
			...
			source:setData("Roleplay:Licencia_Conducir", false)
		end
		--
		...
		if (navegar) then
			...
			source:setData("Roleplay:Licencia_Navegar", false)
		end
		--
		...
		if (piloto) then
			...
			source:setData("Roleplay:Licencia_Piloto", false)
		end
		--
		...
		if (pesca) then
			...
			source:setData("Roleplay:Licencia_Pesca", false)
		end
		--
		...
		if (armas) then
			...
			source:setData("Roleplay:Licencia_Arma", false)
		end
	end
end)
