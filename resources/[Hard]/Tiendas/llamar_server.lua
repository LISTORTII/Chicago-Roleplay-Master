		...
		if player:getData("Roleplay:Telefono") ~="Si" then
			...
			if EnLlamada[player] == true or ApagarCelular[player] == true then
				...
				if tonumber(number) then
					...
					if tonumber(number) == 911 or tonumber(number) == 512 or tonumber(number) == 133 or tonumber(number) == 555 then
			...
			if msg ~="" and msg ~=" " then
				...
				if EnLlamadaEmergencia[player] then
					...
					setTimer(function(p)
						...
						p:outputChat("Muy bien, espere a que la unidad llegue a su ubicacion, mantenga la calma", 0, 150, 0, true)
						...
						for i, v in ipairs(Element.getAllByType("player")) do
							...
							elseif EnLlamadaEmergencia[player] == 133 and v:getData("Roleplay:faccion") == "Mecanico" then
...
addCommandHandler("central", 
	...
	function(player, _, ...)
		...
		if not notIsGuest( player ) then
			...
			if player:getData("Roleplay:faccion") == "Policia" or player:getData("Roleplay:faccion") == "Medico" or player:getData("Roleplay:faccion") == "Mecanico" then
...
addEventHandler( "onPlayerCommand", getRootElement(), 
	...
	function(c)
		...
		if c == 'limpref' then
			...
			if source:getData("Roleplay:faccion") == "Policia" or source:getData("Roleplay:faccion") == "Medico"  or source:getData("Roleplay:faccion") == "Mecanico" then
