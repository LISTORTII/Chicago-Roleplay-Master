				...
				--if thePlayer ~=localPlayer then
					...
					if dist < 10.0 then
						...
						if isLineOfSightClear( px, py, pz, tx, ty, tz, true, false, false, true, false, false, false,localPlayer ) then
						    ...
						    thePlayer:setControlState("walk",true)
							...
							if yo then
								...
								if x and y then
									...
									dxDrawBourdeText(1, ""..yo[1].."",  x, y-100, x, y-100, tocolor((yo[2] or 150),(yo[3] or 0),(yo[4] or 0),255),tocolor(0,0,0,255), 1.3-(dist/15), "default-bold","center",nil, false, false, false, true, false)
							...
							if herido[1] ~= '' then
								...
								if x and y then
									...
									dxDrawBourdeText(1, herido[1]..'', x, y-(50+yOff), x, y-30, tocolor((herido[2] or 150),(herido[3] or 255),(herido[4] or 255),255),tocolor(0,0,0,255), 1.4-(dist/15), "default-bold","center",nil, false, false, false, true, false)
