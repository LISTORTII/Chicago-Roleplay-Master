				...
				if tonumber(who) then
					...
					if (thePlayer) then
						...
						if div ~="" and div ~=" " then
							...
							if div:find("S.W.A.T.") or div:find("INTELIGENCIA") or div:find("s.w.a.t.") or div:find("inteligencia") then
					...
					if (thePlayer) then
						...
						if div ~="" and div ~=" " then
							...
							if div:find("S.W.A.T.") or div:find("INTELIGENCIA") or div:find("s.w.a.t.") or div:find("inteligencia") then
								...
								player:outputChat("* Solo debes asignar las Divisiones: S.W.A.T.  y INTELIGENCIA", 150, 50, 50, true)
