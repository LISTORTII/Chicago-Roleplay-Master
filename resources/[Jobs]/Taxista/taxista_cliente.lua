...
addEventHandler("onClientRender", getRootElement(), function()
	...
	if sx1 and sy1 then
		...
		if distance < 20 then
			...
			dxDrawBorderedText3 ( "Preciona #FF9600F #FFFFFFpara respawnear\nun taxi", sx1, sy1, sx1, sy1 , tocolor (255, 255, 255, 255 ),1, "default-bold","center", "center" ) 
	...
	if sx2 and sy2 then
		...
		if distance < 20 then
			...
			dxDrawBorderedText3 ( "Preciona #FF9600F #FFFFFFpara eliminar\ntu taxi", sx2, sy2, sx2, sy2 , tocolor (255, 255, 255, 255 ),1, "default-bold","center", "center" ) 
